...
public class menu_laporan_cerita_saya extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_laporan_cerita_saya);
    ...
    private void showpostingcerita(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                menu_laporan_cerita_saya.this, list, R.layout.list_laporan_cerita_saya,
                new String[]{konfigurasi.TAG_POSTING_CERITA_ID,
                        konfigurasi.TAG_POSTING_CERITA_TIPE_CERITA,
                        konfigurasi.TAG_POSTING_CERITA_JUDUL,konfigurasi.TAG_POSTING_CERITA_ID_POSTING,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(menu_laporan_cerita_saya.this,
