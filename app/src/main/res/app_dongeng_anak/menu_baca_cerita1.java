...
public class menu_baca_cerita1 extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(menu_baca_cerita1.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void addfeedback(){
        ...
        class Addfeedback extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(menu_baca_cerita1.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(menu_baca_cerita1.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    public void onClick(View v) {
        if(v == btnrating){
            addfeedback();
            Intent intent = new Intent(menu_baca_cerita1.this, menu_semua_cerita.class);
